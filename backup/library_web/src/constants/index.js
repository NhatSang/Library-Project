...
export const sampleReviews = [
  {
    _id: { $oid: "671230f3c8b3dac1047421b6" },
    content: "Cuốn sách này giúp tôi hiểu rõ hơn về chủ đề đang quan tâm.",
    rating: 4,
    user: { $oid: "67122cc699346cfafaff0b3a" },
    book: { $oid: "6708a62db1d6e9e589c26931" },
  ...
  },
  {
    _id: { $oid: "671230f3c8b3dac1047421b6" },
    content:
      "Cuốn sách này thực sự khiến tôi thất vọng. Cốt truyện đơn điệu và dễ đoán, không có bất kỳ yếu tố bất ngờ nào. Các nhân vật cũng rất nhạt nhòa, thiếu chiều sâu và không đủ sức hút để người đọc quan tâm. Ngôn từ khô khan, không lôi cuốn, khiến cảm xúc không được truyền tải tốt. Hơn nữa, thông điệp mà tác giả muốn gửi gắm dường như cũng không rõ ràng. Nếu bạn đang tìm kiếm một câu chuyện hấp dẫn, tôi khuyên bạn nên tìm một tác phẩm khác.",
    rating: 2,
    user: { $oid: "67122cc699346cfafaff0b3a" },
    book: { $oid: "6708a62db1d6e9e589c26931" },
    createdAt: "2024-10-28",
